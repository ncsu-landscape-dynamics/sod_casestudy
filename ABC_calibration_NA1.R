...
## number of infections end of year 2001: 4
## number of infections cumulative 2002: 30
## diff over 2002: 26

## number of infections end of year 2002: 18
## number of infections cumulative 2003: 45
## diff over 2003: 27

## number of infections end of year 2003: 11
## number of infections cumulative 2004: 28
## diff over 2004: 17

## number of infections end of year 2004: 13
## number of infections cumulative 2005: 36
## diff over 2005: 23

## number of infections end of year 2005: 13
## number of infections cumulative 2006: 82
## diff over 2006: 69

## number of infections end of year 2006: 5
## number of infections cumulative 2007: 87
## diff over 2007: 82

## number of infections end of year 2007: 3
## number of infections cumulative 2008: 83
## diff over 2008: 80

## number of infections end of year 2008: 1
## number of infections cumulative 2009: 78
## diff over 2009: 77

## number of infections end of year 2009: 4
## number of infections cumulative 2010: 96
## diff over 2010: 92
...
infected_years_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Infection Data - Proportion/100mLEMMA/Small/Cumulative Infections/cum_inf_2002.tif"
...
infected_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Infection Data - Proportion/100mLEMMA/Small/end_of_year/end_inf_2001.tif"
...
infected_years_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Infection Data - Proportion/100mLEMMA/Small/Cumulative Infections/cum_inf_2003.tif"
number_of_observations <- ### ADDDDDDDDDDD     ### This is the number of infected cells - just make sure it's consistent across years 
...
generation_size <- 1000
checks = c(60,20000,1000,10000)   #### CHECKED USED FOR EU1 : c(60,20000,1000,10000)
infected_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Infection Data - Proportion/100mLEMMA/Small/end_of_year/end_inf_2002.tif"
host_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Host Data - Proportion/SmallerLEMMA/lemma_den100m.tif"
total_plants_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Host Data - Proportion/SmallerLEMMA/lemma_max100m.tif"
temp <- TRUE
...
infected_years_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Infection Data - Proportion/100mLEMMA/Small/Cumulative Infections/cum_inf_2004.tif"
number_of_observations <- ### ADDDDDDDDDDD     ### This is the number of infected cells - just make sure it's consistent across years 
...
generation_size <- 1000
checks = c(60,20000,1000,10000)  #### CHECKED USED FOR EU1 : c(60,20000,1000,10000)
infected_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Infection Data - Proportion/100mLEMMA/Small/end_of_year/end_inf_2003.tif"
host_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Host Data - Proportion/SmallerLEMMA/lemma_den100m.tif"
total_plants_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Host Data - Proportion/SmallerLEMMA/lemma_max100m.tif"
temp <- TRUE
...
infected_years_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Infection Data - Proportion/100mLEMMA/Small/Cumulative Infections/cum_inf_2005.tif"
number_of_observations <- ### ADDDDDDDDDDD     ### This is the number of infected cells - just make sure it's consistent across years 
...
generation_size <- 1000
checks = c(60,20000,1000,10000)   #### CHECKED USED FOR EU1 : c(60,20000,1000,10000)
infected_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Infection Data - Proportion/100mLEMMA/Small/end_of_year/end_inf_2004.tif"
host_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Host Data - Proportion/SmallerLEMMA/lemma_den100m.tif"
total_plants_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Host Data - Proportion/SmallerLEMMA/lemma_max100m.tif"
temp <- TRUE
...
infected_years_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Infection Data - Proportion/100mLEMMA/Small/Cumulative Infections/cum_inf_2006.tif"
number_of_observations <- ### ADDDDDDDDDDD     ### This is the number of infected cells - just make sure it's consistent across years 
...
infected_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Infection Data - Proportion/100mLEMMA/Small/end_of_year/end_inf_2005.tif"
host_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Host Data - Proportion/SmallerLEMMA/lemma_den100m.tif"
total_plants_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Host Data - Proportion/SmallerLEMMA/lemma_max100m.tif"
temp <- TRUE
...
infected_years_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Infection Data - Proportion/100mLEMMA/Small/Cumulative Infections/cum_inf_2007.tif"
number_of_observations <- ### ADDDDDDDDDDD     ### This is the number of infected cells - just make sure it's consistent across years 
...
generation_size <- 1000
checks = c(60,20000,1000,10000)  #### CHECKES USED FOR EU1 : c(60,20000,1000,10000)
infected_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Infection Data - Proportion/100mLEMMA/Small/end_of_year/end_inf_2006.tif"
host_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Host Data - Proportion/SmallerLEMMA/lemma_den100m.tif"
total_plants_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Host Data - Proportion/SmallerLEMMA/lemma_max100m.tif"
temp <- TRUE
...
infected_years_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Infection Data - Proportion/100mLEMMA/Small/Cumulative Infections/cum_inf_2008.tif"
number_of_observations <- ### ADDDDDDDDDDD     ### This is the number of infected cells - just make sure it's consistent across years 
...
generation_size <- 1000
checks = c(60,20000,1000,10000)   #### CHECKES USED FOR EU1 : c(60,20000,1000,10000)
infected_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Infection Data - Proportion/100mLEMMA/Small/end_of_year/end_inf_2007.tif"
host_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Host Data - Proportion/SmallerLEMMA/lemma_den100m.tif"
total_plants_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Host Data - Proportion/SmallerLEMMA/lemma_max100m.tif"
temp <- TRUE
...
infected_years_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Infection Data - Proportion/100mLEMMA/Small/Cumulative Infections/cum_inf_2009.tif"
number_of_observations <- ### ADDDDDDDDDDD     ### This is the number of infected cells - just make sure it's consistent across years 
...
generation_size <- 1000
checks = c(60,20000,1000,10000)   #### CHECKES USED FOR EU1 : c(60,20000,1000,10000)
infected_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Infection Data - Proportion/100mLEMMA/Small/end_of_year/end_inf_2008.tif"
host_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Host Data - Proportion/SmallerLEMMA/lemma_den100m.tif"
total_plants_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Host Data - Proportion/SmallerLEMMA/lemma_max100m.tif"
temp <- TRUE
...
infected_years_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Infection Data - Proportion/100mLEMMA/Small/Cumulative Infections/cum_inf_2010.tif"
number_of_observations <- ### ADDDDDDDDDDD     ### This is the number of infected cells - just make sure it's consistent across years 
...
generation_size <- 1000
checks = c(60,20000,1000,10000)   #### CHECKES USED FOR EU1 : c(60,20000,1000,10000)
infected_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Infection Data - Proportion/100mLEMMA/Small/end_of_year/end_inf_2009.tif"
host_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Host Data - Proportion/SmallerLEMMA/lemma_den100m.tif"
total_plants_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/sudden_oak_death/Oregon/Host Data - Proportion/SmallerLEMMA/lemma_max100m.tif"
temp <- TRUE
